...
function getImgUrl(pm, normal) {
  ...
  let imgBasePath = './vivillon/poke_capture_0';
  //let imgBasePath = './unown/pokemon_icon_';
  ...
  let shiny = normal ? 'f_n' : 'f_r';

// poke_capture_0666_001_mf_n_00000000_f_n - poke_capture_0666_001_mf_n_00000000_f_r  

// raw.githubusercontent.com/ZeChrales/PogoAssets/master/pokemon_icons/pokemon_icon_
//return `//images.weserv.nl/?w=200&il&url=${imgBasePath}${number}${shiny}.png${pm.cachebuster || ''}`;
  return `${imgBasePath}${number}_mf_n_00000000_${shiny}.png${pm.cachebuster || ''}`;
}
